...
public class PedidoDAO {
    public boolean crearPedido(Pedido pedido) {
        String sql = "INSERT INTO pedido (id_usuario, fecha_pedido, estado, id_producto) VALUES (?, ?, ?, ?)";
        try (Connection conn = new Conexion().Conectar();
            ...
            stmt.setInt(4, pedido.getId_producto()); // Establecer el id_producto
        ...
        try (Connection conn = new Conexion().Conectar();
            ...
            while (rs.next()) {
                Pedido pedido = new Pedido(
                        ...
                        rs.getString("estado"),
                        rs.getInt("id_producto") // Obtener el id_producto
                );
                pedidos.add(pedido);
            }
        } catch (SQLException e) {
